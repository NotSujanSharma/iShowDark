		...
		<>
			...
			<Transition show={isOpen}>
				<Dialog onClose={closeMenu}>
					<Dialog.Panel className="fixed inset-0 z-20 flex h-dvh mt-4 w-screen flex-col overflow-y-scroll">
						<Transition.Child
						...
						>
						  ...
						  <span className="text-4xl mt-2 font-serif font-bold bg-gradient-to-r from-blue-600 via-blue-500 to-purple-600 bg-clip-text text-transparent tracking-tight group-hover:scale-105 transition-transform duration-300 inline-block">
							<Logo />
						  </span>
					  </div>
						...
						>
							<ul
								className="flex h-full flex-col divide-y divide-neutral-200 whitespace-nowrap p-3 pt-0 sm:p-8 sm:pt-0 [&>li]:py-3 bg-white"
								id="mobile-menu"
							>
								{children}
							</ul>
